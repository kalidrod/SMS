...
SMS is a lightweight Python script designed to test the resilience of SMS gateways by sending a high volume of messages. It is optimized for the **Termux** environment on Android, providing a portable solution for security researchers and penetration testers.

## 📋 Prerequisites

Before installing SMS, ensure your environment meets the following requirements:
...
You can install SMS using either of the following methods:
...
```bash
git clone https://github.com/kalidrod/SMS.git
```
